  ...
  teamLinks.forEach((teamLink) => {
    ...
    item.innerHTML = `
      ...
      <ul class="nav-dropdown-menu">
        ...
        <li><a href="${leaderboardHref}"${onLeaderboard ? ' aria-current="page"' : ''}>${chinese ? '名人堂' : 'Hall of Fame'}</a></li>
      </ul>
    `;
...
const MONTHLY_ACHIEVERS_FEATURED = {
  label: 'July 2026 Recognition',
  basePath: '/monthly-achievers/2026/JUL2026/',
  files: [
    '1_TOP PRODUCERS (AFYP)_JUL26_LAI SIEW CHING_CHAMPION.webp',
    '2_TOP PRODUCERS (AFYP)_JUL26_ALLAN WONG_FIRST RUNNER UP.webp',
    '3_TOP PRODUCERS (AFYP)_JUL26_KONG SIAW LING_SECOND RUNNER UP.webp',
    '4_TOP PRODUCERS (CASES)_JUL26_LAI SIEW CHING_CHAMPION.webp',
    '5_TOP PRODUCERS (CASES)_JUL26_ALLAN WONG_FIRST RUNNER UP.webp',
    '6_TOP PRODUCERS (CASES)_JUL26_KONG SIAW LING_SECOND RUNNER UP.webp',
    '7_TOP MANAGER(GROUP AFYP)_JUL26_ALLAN WONG_CHAMPION.webp',
    '8_TOP MANAGER(GROUP AFYP)_JUL26_LAI SIEW CHING_FIRST RUNNER UP.webp',
    '9_TOP MANAGER(GROUP AFYP)_JUL26_PERI TAN_SECOND RUNNER UP.webp',
    '10_TOP ROOKIE (CASES & AFYP)_JUL26_KONG SIAW LING_CHAMPION.webp',
    '11_TOP ROOKIE (CASES & AFYP)_JUL26_LAW XIN HUI_FIRST RUNNER UP.webp',
    '12_TOP ROOKIE (CASES & AFYP)_JUL26_KONG SIEW FENG_SECOND RUNNER UP.webp',
    '13_A8CC QUALIFIERS_JUL26.webp',
    '14_A4CC ACHIEVER_JUL26.webp',
    '15_ACP ACHIEVERS_JUL26.webp'
  ]
};
